  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-2 border-indigo-600 bg-indigo-200 p-8 px-12">
        ...
        <div className="flex justify-end gap-2">
          <button onClick={() => {navigate("/dashboard/my-profile") }} className="cursor-pointer rounded-md bg-red-300 py-2 px-5 font-semibold text-richblack-50" >
            Cancel
          </button>
